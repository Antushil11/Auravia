    ...
    <Container>
      <div className="md:flex items-center bg-gradient-to-r from-[#f6eee7] via-[#efe1d4] to-[#e6d1bf] justify-center gap-40 border-2 border-amber-800">
        <div className="gap-4 w-full max-h-full flex flex-col items-center justify-center">
          ...
          <h4 className="text-4xl tinos-regular text-neutral-content">
            Glow with Elegance
          </h4>
          <p className="text-accent-content tinos-regular text-xl text-center">
            Discover Luxurious Skincare & Beauty Products
          </p>
          ...
          <div className=" flex-col gap-4 text-center ">
            ...
            <button className="btn text-accent-content md:mt-0 mt-4 p-6 tinos-regular text-xl px-10 border-2 border-accent-content rounded-xl">
              View Collection
            </button>
          </div>
        </div>
